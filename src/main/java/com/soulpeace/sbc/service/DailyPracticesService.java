...
public interface DailyPracticesService {
    ...
    List<DailyPractices> getPracticesByDateRange(LocalDate practiceStartDate, LocalDate practiceEndDate);
    ...
    List<DailyPractices> getPracticesByUserNameAndDate(String userName, LocalDate practiceStartDate, LocalDate practiceEndDate);
}
